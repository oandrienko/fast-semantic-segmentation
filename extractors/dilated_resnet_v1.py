...
class DownSampleBlock(collections.namedtuple('Block', ['scope', 'unit_fn', 'args'])):
  """ """
...
def dilated_resnet_v1_50(inputs,
  ...
  blocks = [
    ...
    resnet_v1_block('block3', base_depth=256, num_units=6, stride=2, rate=2),
    resnet_v1_block('block4', base_depth=512, num_units=3, stride=1, rate=4),
  ]
